...
- Trabalho de logística: pegue **caixas nas lojas** (até 30 itens/caixa, ~$0,50 por item), carregue na carroça e **entregue no destino**.
- **Carroças por nível**: começa nas pequenas (nível 3 destrava as próprias) e evolui até as grandes.
- Não entregou? Perde metade do pagamento. Aqui palavra vale dinheiro.
- 📄 Página completa do módulo: [Entregador](modulos/entregador.md) (carreira, licença de Tradesman, frota própria).

## 🥃 Destilaria (Moonshine)

- Monte seu **alambique** e produza bebida.
- Riscos reais: o alambique **pega fogo** (repare!) e certas operações exigem movimento da lei na cidade.
- A cadeia legal da destilaria (Alambique Industrial, títulos de exportação de destilaria) é o caminho do dinheiro limpo; o resto... é por sua conta.
- O **módulo Destilaria & Bar** (alambiques Artesanal + Química com XP, bar clandestino, entregas) está detalhado no [Cap.4, item 4.15](04-oficinas.md) e na [página do módulo](modulos/destilaria-bar.md).

## 🐴 Transporte & Mobilidade

| Sistema | O que oferece | Página do módulo |
|---------|---------------|------------------|
| **Estábulos** | comprar/gerir cavalos e carroças; treinador de cavalos; `/dv` deleta cavalo/carroça na rua | [Estábulo](modulos/estabulo.md) |
| **Barcos** | comprar/alugar embarcações (menus: SPACE loja, I barco, G seus barcos) | [Barcos](modulos/barcos.md) |
| **Trens** | transporte pesado e viagens pelo Pantanal | [Trens](modulos/trens.md) |
| **Câmara Fria** | armazene carcaças e carnes sem estragar (frigorífico) | [Freezer](modulos/freezer.md) |

## ⚔️ Clãs & Territórios (jogo paralelo)
